 ...
 * @author foxinline
 */
public abstract class ManagerPesquisarBasico<T extends BasicBean> extends BasicManagerSearch {
    ...
    public void limpar() {
        try {
            ...
            Logger.getLogger(ManagerPesquisarBasico.class.getName()).log(Level.SEVERE, null, ex);
