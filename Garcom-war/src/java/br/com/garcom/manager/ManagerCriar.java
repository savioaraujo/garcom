 ...
 * @author foxinline
 */
public abstract class ManagerCriar<T extends BasicBean> extends BasicManagerCreate {
    ...
    @PostConstruct
    protected void init() {
        parametros = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap();
    ...
    public void instanciar() {
        ...
        try {
            ...
            Logger.getLogger(ManagerCriar.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public String obterParametro(String nome) {
        if (!Utils.isEmpty(parametros) && parametros != null) {
